...
namespace GMap.NET.MapProviders
{
    ...
    public abstract class MyProvider2Base : GMapProvider, RoutingProvider, GeocodingProvider, DirectionsProvider
    {
        public MyProvider2Base()
        {
            MaxZoom = null;
    ...
    /// GoogleMap provider
    /// </summary>
    public class MyMapProvider2 : GoogleMapProviderBase
    {
        public static readonly MyMapProvider2 Instance;

        MyMapProvider2()
        {
        }

        static MyMapProvider2()
        {
            Instance = new MyMapProvider2();
        }
        ...
        string MakeTileImageUrl(GPoint pos, int zoom, string language)
        {
            ...
            string str = string.Format(@"http://139.129.166.245:8091/geoserver/gwc/service/wmts?layer=firefighting%3Alaos&style&tilematrixset=EPSG%3A900913&Service=WMTS&Request=GetTile&Version=1.0.0&Format=image%2Fpng&TileMatrix=EPSG%3A900913%3A{0}&TileCol={1}&TileRow={2}", /*letter, */zoom, pos.X, pos.Y);
            //string str = string.Format(@"http://139.129.166.245:8091/geoserver/gwc/service/wmts?layer=firefighting%3Alaos&style&tilematrixset=GoogleCRS84Quad&Service=WMTS&Request=GetTile&Version=1.0.0&Format=image%2Fpng&TileMatrix=GoogleCRS84Quad%3A{0}&TileCol={1}&TileRow={2}", /*letter, */zoom, pos.X, pos.Y);
            return str;
